...
class Profile extends PureComponent {
  ...
  render() {
    ...
    const { firstName, surName, middleName, oldPassword, newPassword, confirmPassword, image, fileRef } = this.state;
    return (
              ...
              <Grid item xs={4}>
                <AspectRatio className={classes.avatarPreviewWrapper}>
                  <Avatar
                    ...
                    src={image ? image : '/assets/img/no-user-image-big.png'}
                  ></Avatar>
                </AspectRatio>
                <Button className={classes.uploadButton} variant="contained" component="label" color="primary">
                  Выбрать файл
                  <input type="file" style={{ display: 'none' }} ref={fileRef} onChange={this.handleChangeFile} />
                </Button>
              </Grid>
              <Grid item xs={8}>
                <Grid container direction="column" style={{ height: '100%' }}>
                  ...
                  <CardActions className={classes.formActions}>
                    <Button color="primary" variant="contained" disabled={isLoading} onClick={this.submitHandler}>
                      Сохранить
                    </Button>
